// shaders/src/shared.rs
use spirv_std::glam::Mat4;

// Must be repr(C) to match the UBO memory layout the engine uploads
#[repr(C)]
...
// shaders/src/lib.rs  (or shaders/src/vert.rs if you split by stage)
#![cfg_attr(target_arch = "spirv", no_std)]

mod shared;
use shared::ModelViewProjection;
