...
pub struct AssetManager {
    ...
    models: AssetStorage<ModelHierarchy>,

    path_to_model: HashMap<String, Handle<ModelHierarchy>>,
...
impl AssetManager {
    ...
    pub fn load_model(&mut self, name: &str) -> Result<Handle<ModelHierarchy>> {
        ...
        let model_handle = self.models.insert(ModelHierarchy { mesh_instances });
