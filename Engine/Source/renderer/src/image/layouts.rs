...
impl Image {
    pub fn transition_image_layout(
        ...
        let (src_access, src_stage) = src_layout_info(old_layout)?;
        let (dst_access, dst_stage) = dst_layout_info(new_layout)?;
...
fn src_layout_info(layout: vk::ImageLayout) -> Result<(vk::AccessFlags, vk::PipelineStageFlags)> {
    match layout {
...
fn dst_layout_info(layout: vk::ImageLayout) -> Result<(vk::AccessFlags, vk::PipelineStageFlags)> {
    match layout {
        vk::ImageLayout::COLOR_ATTACHMENT_OPTIMAL => Ok((
            vk::AccessFlags::COLOR_ATTACHMENT_WRITE,
            vk::PipelineStageFlags::COLOR_ATTACHMENT_OUTPUT,
